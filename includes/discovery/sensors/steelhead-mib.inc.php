...
$value = snmp_get($device, 'systemHealth.0', '-Oqv', 'STEELHEAD-MIB');
...
$value = snmp_get($device, 'optServiceStatus.0', '-Oqv', 'STEELHEAD-MIB');
...
$value = snmp_get($device, 'systemTemperature.0', '-Oqv', 'STEELHEAD-MIB');
