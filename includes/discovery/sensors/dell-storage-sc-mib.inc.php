...
$cml['temp'] = snmpwalk_cache_oid($device, 'scEnclTempTable', array(), 'DELL-STORAGE-SC-MIB');
$cml['fan'] = snmpwalk_cache_oid($device, 'scEnclFanTable', array(), 'DELL-STORAGE-SC-MIB');
$cml['ctrl'] = snmpwalk_cache_oid($device, 'scCtlrEntry', array(), 'DELL-STORAGE-SC-MIB');
$cml['disk'] = snmpwalk_cache_oid($device, 'scDiskEntry', array(), 'DELL-STORAGE-SC-MIB');
$cml['cache'] = snmpwalk_cache_oid($device, 'ScCacheEntry', array(), 'DELL-STORAGE-SC-MIB');
