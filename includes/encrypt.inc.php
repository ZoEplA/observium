...
function encrypt_mcrypt($string, $key)
{
  ...
  $key = pad_key($key);
  $encrypted = safe_base64_encode(mcrypt_encrypt(MCRYPT_RIJNDAEL_256, $key, $string, MCRYPT_MODE_ECB));
  return $encrypted;
}
